...
public sealed class UserAuthenticator : IDisposable
{
    ...
    private OidcClient CreateOidcClient(string htmlTitle, string htmlBody)
    {
        ...
        var options = new OidcClientOptions
        {
            ...
            GetClientAssertionAsync = () => Task.FromResult(ClientAssertionBuilder.Build(_clientData.ClientId, _clientData.Jwk.PublicAndPrivateValue, _clientData.Authority, assertionDetails: null)),
